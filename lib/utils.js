 ...
 */
  ...
  {
    "type": "event",
    "threadID": "1184034474942360",
    "logMessageType": "log:unsubscribe",
    "logMessageData": {
      "leftParticipantFbId": "100014150825884"
    },
    "logMessageBody": "Smelly  whi snore very loudly removed Tony Bot from the group.",
    "author": "741858200",
    "eventType": "event"
  }
   */
  ...
  allyKicked: (event) => {
    ...
    const kicked = _.get(event, 'logMessageData.leftParticipantFbId') || event.kicked;
